        ...
        sortedPaymentRequests.map((request, index) => {
          ...
          return (
            <div key={index} className=" border-0 border-b border-gray-300 w-full mt-0">
              ...
              <div className={"relative h-12 w-12 border-2 " + (request.transaction_state === "Pending" ? "border-base-blue" : "border-gray-300") + " rounded-3xl ml-0" + (!request.transaction_message ? " -mb-2" : " -mb-3.5")}>
